    ...
    try {
      ...
      const groupsList = await db
        .select({
          ...
          discoverRequestedAt: groups.discoverRequestedAt,
          discoverRequestedMessage: groups.discoverRequestedMessage,
          discoverReviewNote: groups.discoverReviewNote,
          discoverReviewedAt: groups.discoverReviewedAt,
