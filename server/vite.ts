...
export function serveStatic(app: Express) {
  ...
  // BUT ONLY for GET requests (browser navigation)
  // API routes (POST/PUT/DELETE) should return 404, not HTML
  app.use("*", (req, res) => {
    // Only serve index.html for GET requests (client-side routing)
    if (req.method !== 'GET') {
